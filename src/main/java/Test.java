...
public class Test {
    public static void main(String[] args) {
       ...
       // PopReversal2TheHalvening.getSeedFromChunkseedPre13(decoratorSeed ^ Rand.JAVA_LCG.multiplier, (posX - 8) >> 4, (posZ - 8) >> 4).forEach(System.out::println);
        ...
        posY = 84;
        posZ = -654;
        String stringPattern = "001101011111011111101100000100110111110111001011111101100110110";
        // 1 mossy
        // 0 cobble
        //============================================================ END INPUT
        posX -= 8;
        ...
        long[] seeds = new long[]{172677341711898L};
        for (long seed : seeds) {
    ...
    private static void check(long seed, int offsetX, int posY, int offsetZ, String pattern) {
        ...
        System.out.print(random.nextInt(16));
        System.out.print(" ");
        System.out.print(random.nextInt(16));
        System.out.print(" ");
