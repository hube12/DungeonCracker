...
//        device.streamSeeds().parallel().forEach(System.out::println);
        ...
        switch (version) {
            ...
            case 10: new VersionCrack(v1_16, 25, 54, 88, "0111010110011110110100010101110110101110111111111", Biomes.DESERT).runTest(); break;
    ...
    /*public static void test(MCVersion version) {
        // 1.17                       Dungeon Seed: [137229083672372]; Coords: [25 54 88]; World Seed: [1488979889728021444]
