...
import java.util.stream.Collectors;
    ...
    public enum MCVersion {
        ...
        private static final Map<String, MCVersion> STRING_TO_VERSION = Arrays.stream(values()).collect(Collectors.toMap(MCVersion::toString, (o) -> o));
        public final String name;
        public final int release;
        public final int subVersion;
        public final int snapshot;

        private MCVersion(String name, int release, int subVersion, int snapshot) {
            this.name = name;
